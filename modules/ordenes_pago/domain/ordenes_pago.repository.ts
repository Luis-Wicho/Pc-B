...
import { ordenes_pago } from "./ordenes_pago.entity";
...
export interface OrdenPagoRepository {
  ...
  create(ordenPago:ordenes_pago): Promise<ordenes_pago>;
  ...
  update(ordenPago: ordenes_pago): Promise<ordenes_pago>;
  ...
  findById(id: number): Promise<ordenes_pago| null>;
}